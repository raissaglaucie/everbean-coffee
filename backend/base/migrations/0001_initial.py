    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='products/placeholder.jpg', null=True, upload_to='products/')),
                ('category', models.CharField(blank=True, choices=[('drinks', 'Drinks'), ('beans', 'Beans'), ('food', 'Food'), ('merch', 'Merch')], max_length=200, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('origin', models.CharField(blank=True, max_length=200, null=True)),
                ('roast_level', models.CharField(blank=True, choices=[('light', 'Light'), ('medium', 'Medium'), ('dark', 'Dark'), ('extra-dark', 'Extra Dark')], max_length=50, null=True)),
                ('brew_method', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='default/avatar.jpg', null=True, upload_to='avatars/')),
